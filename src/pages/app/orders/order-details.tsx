...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 28481</DialogTitle>
      ...
      <div className="space-y-6">
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">(21) 971787414</TableCell>
            </TableRow>
        ...
        <Table>
          ...
          <TableFooter>
            ...
            <TableCell className="text-right font-medium">R$259.80</TableCell>
          </TableFooter>
        </Table>
      </div>
    </DialogContent>
